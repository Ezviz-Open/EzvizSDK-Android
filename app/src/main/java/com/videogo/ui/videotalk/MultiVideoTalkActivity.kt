...
import com.videogo.ui.videotalk.widget.VideoTalkAdapter
import com.videogo.ui.videotalk.widget.VideoTalkView
...
//        adapter!!.setData(videoTalkList)
    ...
    private fun joinRoom(clientId: Int, username: String) {
        ...
        val videoTalkBean : VideoTalkBean =
            VideoTalkBean(clientId, username, 1, 1)
        videoTalkMap[clientId] = videoTalkBean
